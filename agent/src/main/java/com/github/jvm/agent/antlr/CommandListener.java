...
public interface CommandListener extends ParseTreeListener {
     ...
     * @param ctx the parse tree
     */
    void enterDump_command(CommandParser.Dump_commandContext ctx);

    /**
     * Exit a parse tree produced by {@link CommandParser#dump_command}.
     *
     * @param ctx the parse tree
     */
    void exitDump_command(CommandParser.Dump_commandContext ctx);

    /**
     * Enter a parse tree produced by {@link CommandParser#reset_command}.
     *
     * @param ctx the parse tree
     */
    void enterReset_command(CommandParser.Reset_commandContext ctx);

    /**
     * Exit a parse tree produced by {@link CommandParser#reset_command}.
     *
     * @param ctx the parse tree
     */
    void exitReset_command(CommandParser.Reset_commandContext ctx);

    /**
     * Enter a parse tree produced by {@link CommandParser#shut_command}.
     *
     * @param ctx the parse tree
     */
    void enterShut_command(CommandParser.Shut_commandContext ctx);

    /**
     * Exit a parse tree produced by {@link CommandParser#shut_command}.
     *
     * @param ctx the parse tree
     */
    void exitShut_command(CommandParser.Shut_commandContext ctx);
